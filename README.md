...
2. Sélectionnez la base de données **`projet`** dans la colonne de gauche (elle existe par défaut).
...
Le fichier de configuration est ignoré par Git pour des raisons de sécurité. Vous devez le créer ou le modifier sur le serveur.
